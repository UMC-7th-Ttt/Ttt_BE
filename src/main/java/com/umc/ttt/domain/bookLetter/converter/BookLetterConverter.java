...
public class BookLetterConverter {
    ...
    public static BookLetter toBookLetter(BookLetterRequestDTO.CUDto request, String coverImg, Member member) {
    ...
    public static BookLetterResponseDTO.BookLetterDTO bookLetterDTO(BookLetter bookLetter, Member member) {
        ...
        boolean isWriter = bookLetter.getEditorMember().equals(member);
