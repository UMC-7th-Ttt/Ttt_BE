...
@RequestMapping("/api/admin/book-letters")
public class BookLetterAdminController {
    ...
    public ApiResponse<BookLetterResponseDTO.CRDResultDTO> addBookLetter(@Parameter(content = @Content(mediaType = MediaType.MULTIPART_FORM_DATA_VALUE))
        ...
        BookLetter bookLetter = bookLetterCommandService.addBookLetter(request, bookLetterCover,member);
